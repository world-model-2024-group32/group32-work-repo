...
class UR5SimpleRobotWrapper:
    ...
    RIGHT_SAFE_XY_MAX = (RIGHT_XY_MAX[0] - X_ADJ, RIGHT_XY_MAX[1] - Y_ADJ)
...
class EnvConfig:
    ...
    use_real: bool = True
    robot_type: RobotType = RobotType.UR5
    enable_z: bool = True
...
class BaseEnv:
    def __init__(self, cfg: EnvConfig):
        ...
        self.cfg = cfg
        self._arm: Union[UR5SimpleRobotWrapper]
        if cfg.use_real:
    ...
    def get_reward(self, curr_obs: Dict[str, Any]) -> float:
        """Provide the environment reward.
